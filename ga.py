...
def tournament_selection(JSSP_cur):
    ...
    if (
        JSSP_cur.population_fitness[candidates[0]]
        <= JSSP_cur.population_fitness[candidates[1]]
    ):
    ...
    for generation in range(
        ...
        while index_to_add < num_population:
            ...
            if (
                ...
                child1 = (
                    JSSP_cur.mutation_swap(
                        child1
                    )
                )

            mutation_probability2 = (
                JSSP_cur.rng.random()
            )
        ...
        generation_results.append({
            ...
            "best":
                int(generation_best_makespan),

            "worst":
                int(generation_worst_makespan),
